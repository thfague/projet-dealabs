...
final class Version20200626125851 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_badge_utilisateur (user_badge_id INT NOT NULL, utilisateur_id INT NOT NULL, INDEX IDX_BFAEA4F172F26FC (user_badge_id), INDEX IDX_BFAEA4FFB88E14F (utilisateur_id), PRIMARY KEY(user_badge_id, utilisateur_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
