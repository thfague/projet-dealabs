 ...
 */
final class Version20200512102903 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE categorie (id INT AUTO_INCREMENT NOT NULL, deals_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, INDEX IDX_497DD63497ED4789 (deals_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE deal (id INT AUTO_INCREMENT NOT NULL, auteur_id INT NOT NULL, type_id INT NOT NULL, prix DOUBLE PRECISION NOT NULL, fdp DOUBLE PRECISION NOT NULL, livraison TINYINT(1) NOT NULL, prix_hab DOUBLE PRECISION NOT NULL, note INT NOT NULL, date_publication DATE NOT NULL, description VARCHAR(255) DEFAULT NULL, INDEX IDX_E3FEC11660BB6FE6 (auteur_id), INDEX IDX_E3FEC116C54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE categorie ADD CONSTRAINT FK_497DD63497ED4789 FOREIGN KEY (deals_id) REFERENCES deal (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE categorie DROP FOREIGN KEY FK_497DD63497ED4789');
